...
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(837);
...
const writeFileAsync = (0,util__WEBPACK_IMPORTED_MODULE_4__.promisify)(fs__WEBPACK_IMPORTED_MODULE_2__.writeFile);

main().catch((error) => (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed)(error.message));

async function main() {
  try {
    const creds = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('GOOGLE_APPLICATION_CREDENTIALS');
    if (!creds) {
    ...
    const path = (0,path__WEBPACK_IMPORTED_MODULE_3__.join)(tempDirectory, 'GOOGLE_ACCOUNT_CREDENTIALS.json');
    await writeFileAsync(path, creds);
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)('GOOGLE_APPLICATION_CREDENTIALS_JSON', path);
  } catch (error) {
...
async function createTempDirectory() {
  ...
  if (!tempDirectory) {
    ...
    tempDirectory = (0,path__WEBPACK_IMPORTED_MODULE_3__.join)(baseLocation, 'actions', 'temp');
  }
  const dest = (0,path__WEBPACK_IMPORTED_MODULE_3__.join)(tempDirectory, 'secrets');
  await (0,_actions_io__WEBPACK_IMPORTED_MODULE_1__.mkdirP)(dest);
  return dest;
}
